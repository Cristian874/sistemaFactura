      ...
      <form class="proveedores contenedor">
        <div class=" buscador-boton">
          ...
          <div class="boton-buscador">
            <input type="button" value="Buscar " name="botonbuscador" class="boton pro-buscar" />
          </div>
        </div>
      </form>
    </div><!--cerramos el buscador-->
<section class="tabla contenedor">
<h2 class="text-center mt-5 listado-h2">Listado de todos los registros con relación a las operaciones de  gastos</h2>
...
<table class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Fecha Pago o Transferencia</th>
